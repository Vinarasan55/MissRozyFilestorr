...
BANNED_CHANNELS = list(set(int(x) for x in str(getenv("BANNED_CHANNELS", "-1002243746308")).split())) 
STREAM_LOGS = environ.get('STREAM_LOGS','-1002243746308')
SESSION = environ.get('SESSION','MissRozy')
CUSTOM_CAPTION = environ.get('CUSTOM_CAPTION')


class Config(object):
	API_ID = int(os.environ.get("API_ID", "9747098"))
	API_HASH = os.environ.get("API_HASH", "15384775587d976eccc8b367e92a96a3")
	BOT_TOKEN = os.environ.get("BOT_TOKEN","7177175125:AAHWf4Eod7rSkz2hZ_0qV9pidLoKXabLt0E")
	BOT_USERNAME = os.environ.get("BOT_USERNAME" , "Foxy_FileStore_Bot")
	DB_CHANNEL = int(os.environ.get("DB_CHANNEL", "-1001860008836"))
	BOT_OWNER = int(os.environ.get("BOT_OWNER", "1287471711"))
	DATABASE_URL = os.environ.get("DATABASE_URL","mongodb+srv://FoxyFileStore:FoxyFileStore@foxyfilestore.jsvmihn.mongodb.net/?retryWrites=true&w=majority")
	UPDATES_CHANNEL = os.environ.get("UPDATES_CHANNEL", "-1002194339173")
	LOG_CHANNEL = os.environ.get("LOG_CHANNEL", "-1002243746308")
  ...
  # LP_CUSTOM_TEMPLATE= os.environ.get("LP_CUSTOM_TEMPLATE","{file_name} - example \n\n Please Upadate this template acording to you @LazyDeveloperr ")
	BANNED_CHAT_IDS = list(set(int(x) for x in os.environ.get("BANNED_CHAT_IDS", "-1001860008836").split()))
